...
photologo = 'https://files.catbox.moe/hn7kyr.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://files.catbox.moe/hn7kyr.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://files.catbox.moe/hn7kyr.jpg'
photozip = 'https://files.catbox.moe/hn7kyr.jpg'
...
image_urls = [
    "https://files.catbox.moe/hn7kyr.jpg",
    "https://files.catbox.moe/hn7kyr.jpg",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://files.catbox.moe/hn7kyr.jpg",
        caption=caption
    )
...
async def id_command(client, message: Message):
    keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(text="Send to Owner", url=f"https://t.me/Nikhilbhaiiibot")]])
...
async def text_handler(bot: Client, m: Message):
    ...
    try:
            ...
            if "acecwply" in url:
                ...
                url = url.replace("https://cpvod.testbook.com/","https://media-cdn.classplusapp.com/drm/")
                url = f"https://dragoapi.vercel.app/classplus?link=" + url
                mpd, keys = helper.get_mps_and_keys(url)
                url = mpd
                keys_string = " ".join([f"--key {key}" for key in keys])
                ...
                url = f"https://anonymouspwplayer-25261acd1521.herokuapp.com/pw?url={url}&token={pw_token}"
